...
@NoArgsConstructor
@Data
public class OrderAllocatedEvent extends BaseEvent {
	private OrderDTO orderDTO;
	private static String EVENT_NAME = "OrderAllocatedEvent";
	public OrderAllocatedEvent(OrderDTO orderDTO) {
		this(orderDTO, null);
	}

	public OrderAllocatedEvent(OrderDTO orderDTO, Map headerMap) {
		super(EVENT_NAME);
