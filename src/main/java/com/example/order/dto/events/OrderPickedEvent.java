...
@NoArgsConstructor
@Data
public class OrderPickedEvent extends BaseEvent {
	private OrderDTO orderDTO;
	private static String EVENT_NAME = "OrderPickedEvent";
	public OrderPickedEvent(OrderDTO orderDTO) {
		this(orderDTO, null);
	}

	public OrderPickedEvent(OrderDTO orderDTO, Map headerMap) {
		super(EVENT_NAME);
