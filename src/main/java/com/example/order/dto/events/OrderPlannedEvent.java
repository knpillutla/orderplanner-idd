...
@NoArgsConstructor
@Data
public class OrderPlannedEvent extends BaseEvent {
	private OrderDTO orderDTO;
	private static String EVENT_NAME = "OrderPlannedEvent";
	public OrderPlannedEvent(OrderDTO orderDTO) {
		this(orderDTO, null);
	}

	public OrderPlannedEvent(OrderDTO orderDTO, Map headerMap) {
		super(EVENT_NAME);
