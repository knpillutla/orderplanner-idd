...
@NoArgsConstructor
@Data
public class OrderPackedEvent extends BaseEvent {
	private OrderDTO orderDTO;
	private static String EVENT_NAME = "OrderPackedEvent";
	public OrderPackedEvent(OrderDTO orderDTO) {
		this(orderDTO, null);
	}

	public OrderPackedEvent(OrderDTO orderDTO, Map headerMap) {
		super(EVENT_NAME);
