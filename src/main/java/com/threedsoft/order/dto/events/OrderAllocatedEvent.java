...
@NoArgsConstructor
@Data
public class OrderAllocatedEvent extends WMSEvent {
	public OrderAllocatedEvent(OrderResourceDTO resourceDTO, String serviceName) {
		this(resourceDTO, serviceName, null);
	}

	public OrderAllocatedEvent(OrderResourceDTO resourceDTO, String serviceName, Map headerMap) {
		super("OrderAllocatedEvent", resourceDTO.getBusName(), resourceDTO.getLocnNbr(),
