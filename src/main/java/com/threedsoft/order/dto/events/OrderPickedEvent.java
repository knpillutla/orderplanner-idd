...
@NoArgsConstructor
@Data
public class OrderPickedEvent extends WMSEvent {
	public OrderPickedEvent(OrderResourceDTO resourceDTO, String serviceName) {
		this(resourceDTO, serviceName, null);
	}

	public OrderPickedEvent(OrderResourceDTO resourceDTO, String serviceName, Map headerMap) {
		super("OrderPickedEvent", resourceDTO.getBusName(), resourceDTO.getLocnNbr(),
