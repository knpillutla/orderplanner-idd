...
@NoArgsConstructor
@Data
public class OrderPackedEvent extends WMSEvent {
	public OrderPackedEvent(OrderResourceDTO resourceDTO, String serviceName) {
		this(resourceDTO, serviceName, null);
	}

	public OrderPackedEvent(OrderResourceDTO resourceDTO, String serviceName, Map headerMap) {
		super("OrderPackedEvent", resourceDTO.getBusName(), resourceDTO.getLocnNbr(),
